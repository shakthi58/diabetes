...
if st.button("Predict"):
    ...
    if bmi < 18.5:
        ...
        st.write("- Emphasize low-calorie foods and avoid processed foods entirely.")
    ...
    if blood_pressure < 90:
        ...
        st.write("- Maintain a diet rich in fruits, vegetables, and whole grains.")
        ...
        st.write("- Include potassium-rich foods like bananas and sweet potatoes.")
        st.image("carbohydrates.jpg")
    else:
        st.error("High blood pressure detected. Immediate action is recommended.")
        st.write("### Diet Recommendations for High Blood Pressure:")
        st.write("- Follow a DASH diet (Dietary Approaches to Stop Hypertension).")
    ...
    if skin_thickness < 10:
        st.warning("Low skin thickness detected. Potential nutritional concerns.")
        st.write("### Diet Recommendations for Low Skin Thickness:")
        st.write("- Increase protein intake through lean meats, eggs, and legumes.")
        st.write(
    ...
    if diabetes_pedigree < 0.5:
        ...
        st.write("### Diet Recommendations for High Diabetes Pedigree Function:")
